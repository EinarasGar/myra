...
pub(crate) fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/users/{user_id}/transactions/groups",                              get(   handlers::transaction_groups::get_transaction_groups))
        ...
        .route("/api/users/{user_id}/categories",                                       get(   handlers::category_handler::search_categories))
        .route("/api/users/{user_id}/categories",                                       post(  handlers::category_handler::create_category))
        .route("/api/users/{user_id}/categories/{category_id}",                         get(   handlers::category_handler::get_category))
        .route("/api/users/{user_id}/categories/{category_id}",                         put(   handlers::category_handler::update_category))
        .route("/api/users/{user_id}/categories/{category_id}",                         delete(handlers::category_handler::delete_category))
        .route("/api/users/{user_id}/categories/types",                                 get(   handlers::category_handler::get_category_types))
        .route("/api/users/{user_id}/categories/types",                                 post(  handlers::category_handler::create_category_type))
        .route("/api/users/{user_id}/categories/types/{type_id}",                       put(   handlers::category_handler::update_category_type))
        .route("/api/users/{user_id}/categories/types/{type_id}",                       delete(handlers::category_handler::delete_category_type))
