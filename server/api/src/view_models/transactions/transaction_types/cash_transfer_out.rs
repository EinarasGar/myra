...
impl<E: Into<EntryDto>> From<CashTransferOut<TransactionBaseWithEntries, E>> for TransactionDto {
    fn from(value: CashTransferOut<TransactionBaseWithEntries, E>) -> Self {
        TransactionDto {
            transaction_id: None,
