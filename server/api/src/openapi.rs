...
#[openapi(
    ...
    paths(
        ...
        super::handlers::user_asset_handler::get_user_asset_pair_converted,
        super::handlers::user_asset_handler::get_user_asset_pair_converted_rates,
        ...
        super::handlers::asset_handler::get_asset_pair_converted,
        super::handlers::asset_handler::get_asset_pair_converted_rates,
        ...
        super::handlers::portfolio_handler::get_portfolio_asset_overview,
        ...
        super::handlers::connectors_handler::create_connection,
        super::handlers::connectors_handler::list_connections,
        super::handlers::connectors_handler::revoke_connection,
