  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-lg">
        ...
        {!selectedType && (
          <TransactionTypeSelector onSelected={setSelectedType} />
        )}
        {selectedType === "asset_purchase" && (
          <AddAssetPurchaseForm onCollect={handleCollect} />
        )}
        {selectedType === "asset_sale" && (
          <AddAssetSaleForm onCollect={handleCollect} />
        )}
        {selectedType === "cash_transfer_in" && (
          <AddCashTransferInForm onCollect={handleCollect} />
        )}
        {selectedType === "cash_transfer_out" && (
          <AddCashTransferOutForm onCollect={handleCollect} />
        )}
        {selectedType === "cash_dividend" && (
          <AddCashDividendForm onCollect={handleCollect} />
        )}
        {selectedType === "asset_dividend" && (
          <AddAssetDividendForm onCollect={handleCollect} />
        )}
        {selectedType === "asset_transfer_out" && (
          <AddAssetTransferOutForm onCollect={handleCollect} />
        )}
        {selectedType === "asset_transfer_in" && (
          <AddAssetTransferInForm onCollect={handleCollect} />
        )}
        {selectedType === "asset_trade" && (
          <AddAssetTradeForm onCollect={handleCollect} />
        )}
