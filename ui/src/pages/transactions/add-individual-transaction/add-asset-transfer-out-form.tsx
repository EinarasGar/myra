...
interface AddAssetTransferOutFormProps {
  onSuccess?: () => void;
}

export default function AddAssetTransferOutForm({
  onSuccess,
}: AddAssetTransferOutFormProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <span className="text-sm font-medium">Asset to Transfer Out</span>
