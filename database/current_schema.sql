...
CREATE TABLE IF NOT EXISTS transaction_category_type (
    ...
    CONSTRAINT transaction_category_type_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS transaction_categories (
    ...
    CONSTRAINT transaction_categories_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);
...
-- Indexes for transaction_category_type
