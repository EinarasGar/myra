...
import { individualProposalToFormValues } from "./proposal-to-form-values";
...
export function QuickUploadReviewIndividual({
  quickUploadId,
  open,
  onOpenChange,
}: Props) {
  ...
  const initialValues = useMemo(() => {
    ...
    return individualProposalToFormValues(dto.proposal_data, dto.lookup_tables);
  }, [detailQuery.data]);
